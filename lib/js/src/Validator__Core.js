...
function _evalSync(errStackRef, value, _validator) {
  while(true) {
    ...
    switch (validator.TAG | 0) {
      ...
      case /* AND */1 :
          if (_evalSync(errStackRef, value, validator.a)) {
            if (_evalSync(errStackRef, value, validator.b)) {
      ...
      case /* OR */2 :
          if (_evalSync(errStackRef, value, validator.a)) {
            ...
            return true;
          } else if (_evalSync(errStackRef, value, validator.b)) {
            if (errStack.length !== 0) {
              errStackRef.contents = [];
            }
            return true;
      ...
      case /* XOR */3 :
          var match = _evalSync(errStackRef, value, validator.a);
          var match$1 = _evalSync(errStackRef, value, validator.b);
          if (match) {
            if (match$1) {
              errStack[errStack.length] = validator;
              return false;
      ...
      case /* NOT */4 :
          ...
          switch (a.TAG | 0) {
            ...
            case /* NOT */4 :
                ...
                continue ;
            default:
              if (_evalSync(errStackRef, value, a)) {
                errStack[errStack.length] = validator;
                return false;
              } else {
                if (errStack.length !== 0) {
...
function validate(stringify, validator, value) {
  ...
  var result = _evalSync(errStackRef, value, validator);
  if (result) {
    return {
            TAG: /* Ok */0,
            _0: value
