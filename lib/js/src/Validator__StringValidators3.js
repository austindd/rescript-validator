...
function isShorterThan(length) {
  ...
  return Validator__Core3.make(name, (function (value) {
                return Validator__Core3.defaultErrorMessage(undefined, name, value);
              }), (function (str) {
...
var isHelloWorld = Validator__Core3.make("isHelloWorld", undefined, (function (str) {
...
var isEmail = Validator__Core3.make("isEmail", undefined, (function (str) {
