...
function defaultErrorMessage(stringify, name, value) {
  var valueString = stringify !== undefined ? Curry._1(stringify, value) : "" + value;
...
function _makeError(validator, value) {
  if (validator.TAG === /* Validator */0) {
    ...
    return {
            ...
            validator: validator,
            validatorName: name,
            message: message !== undefined ? message(value) : defaultErrorMessage(undefined, name, value)
          };
  }
  ...
  return {
          value: value,
          validator: validator,
          validatorName: name$1,
          message: defaultErrorMessage(undefined, name$1, value)
        };
}
...
function evalSync(validator, value) {
  ...
  Belt_Array.forEachU(errStack, (function (v) {
          errors.push(_makeError(v, value));
