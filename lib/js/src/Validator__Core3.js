...
function makeDefaultErrorMessage(stringify, name, value) {
...
function make(name, message, validate) {
  return {
          ...
          message: message !== undefined ? message : (function (value) {
                return makeDefaultErrorMessage(undefined, name, value);
              })
        };
}
...
function validate(valueToString, validator, value) {
  var errStackRef = {
    contents: []
  };
  var errors = [];
  ...
  Belt_Array.forEachU(errStack, (function (v) {
          errors.push(_makeError(valueToString, v, value));
...
var Impl = {
  makeDefaultErrorMessage: makeDefaultErrorMessage,
  getName: getName,
...
exports.Impl = Impl;
exports.makeDefaultErrorMessage = makeDefaultErrorMessage;
