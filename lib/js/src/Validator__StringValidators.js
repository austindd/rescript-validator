...
function isShorterThan(length) {
  ...
  return Validator__Core.make(name, (function (value) {
                return Validator__Core.defaultErrorMessage(undefined, name, value);
              }), (function (str) {
...
var isHelloWorld = Validator__Core.make("isHelloWorld", undefined, (function (str) {
...
var isEmail = Validator__Core.make(name, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name, value);
      }), (function (str) {
...
var isNotEmpty = Validator__Core.make(name$1, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name$1, value);
      }), (function (str) {
        return str !== "";
      }));
...
var isEmpty = Validator__Core.make(name$2, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name$2, value);
      }), (function (str) {
        return str === "";
      }));
...
var containsWhitespaceChar = Validator__Core.make(name$3, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name$3, value);
      }), (function (str) {
...
var containsNonWhitespaceChar = Validator__Core.make(name$4, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name$4, value);
      }), (function (str) {
...
var containsOnlyDigits = Validator__Core.make(name$5, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name$5, value);
      }), (function (str) {
...
var isFloat = Validator__Core.make(name$6, (function (value) {
        return Validator__Core.defaultErrorMessage(undefined, name$6, value);
      }), (function (str) {
